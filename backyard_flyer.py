...
class BackyardFlyer(Drone):
    def __init__(self, connection):
        ...
        self.target_position = np.array([0.0, 0.0, 0.0])  # initial take of altitute
        self.all_waypoints = []
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            if -1.0 * self.local_position[2] > 0.95 * self.target_position[2]:
                # if there is no waypoints, populate the array
    ...
    def calculate_box(self):
        ...
        """
        waypoints = [
            [10, 0, self.target_position[2]],
            [10, 10, self.target_position[2]],
            [0, 10, self.target_position[2]],
